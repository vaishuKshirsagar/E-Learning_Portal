...
<h1 class="text-center mt-5">Video Tutorials</h1>
...
if($result->num_rows>0){
  ...
  <div class="col-sm-4 mb-4">
    ...
    <div class="card-body">
      ...
      <a href="videoTutDetails.php?course_id='.$course_id.'" class="btn btn-primary text-white fw-bold float-end "><i class="fa fa-play-circle me-2"></i>Enroll Now</a>
      </div>
    </div>
  </div>
</div>
